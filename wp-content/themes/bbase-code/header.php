    ...
    <header class="HeaderWrapper headerMain" style="">
            ...
            <div class="topBarBetween">
                ...
                <div class="listSC">
                    <div class="itemWrapperSC">
                        <div class="linkItemSC"><img style="width:15px"
                                src="<?php echo get_template_directory_uri(); ?>/assets/images/telephone.png" />
                            086-441-3515</div>
                        <span class="subTitleSC">営業時間 10:00～18:00（祝日、土日を除く）</span>
                    </div>
        ...
        <div class="menuWrapper-sc">
            <div class="menuGrid-sc">
                ...
                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/Logo.87aa8d22.svg" alt="logo"
                    data-href="https://kurabun-ec-develop.vercel.app/" class="logoImage-sc" />
                <div class="menuSearch-sc">
                    <form class="formSearch-sc" method="GET">
                        <button class="buttonSearch-sc"><img alt="icon-search"
                                src="<?php echo get_template_directory_uri(); ?>/assets/images/search.14dd4c8b.svg"
                                class="iconSearchProduct-sc" /></button>
                        <input type="text" placeholder="キーワード（例：バッグ）" class="menuInput-sc" value="" />
                        <a class="buttonSearch-sc buttonClose hidden">
                            <img alt="icon-close"
                                src="<?php echo get_template_directory_uri(); ?>/assets/images/close.b3b62189.svg"
                                class="iconSearchProduct-sc">
                        </a>
                    </form>
                </div>
                <div class="menuUser-sc">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/search.14dd4c8b.svg"
                        alt="Menu-icon" class="icon-sc" />
                    <div class="iconWrapper-sc">
                        <button data-testid="btn-submit" type="submit" class="button-sc"
                            data-href="https://kurabun-ec-develop.vercel.app/favorite">
                            <div type="primary-ghost" class="notificationButtonWrapper-sc">
                                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/email.bdc65baf.svg"
                                    alt="icon" class="image-sc" />
                                <?php
                                    if($countWishlist)
                                    {
                                        ?>
                    ...
                    <div class="iconWrapper-sc">
                        <button data-testid="btn-submit" type="submit" class="button-sc"
                            data-href="https://kurabun-ec-develop.vercel.app/favourite">
                            <div type="primary-ghost" class="notificationButtonWrapper-sc">
                                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/heart.29d433ab.svg"
                                    alt="icon" class="image-sc" />
                                <?php
                                    if($countCart)
                                    {
                    ...
                    <div class="iconWrapper-sc">
                        <button data-testid="btn-submit" type="submit" disabled="" class="button-sc"
                            data-href="https://kurabun-ec-develop.vercel.app/favourite">
                            <div type="primary-ghost" class="notificationButtonWrapper-sc"><img
                                    src="<?php echo get_template_directory_uri(); ?>/assets/images/bag-2.74a784a6.svg"
                                    alt="icon" class="image-sc" /></div>
                        </button>
                    ...
                    <button data-testid="btn-submit" type="submit" class="button-usersc button-sc">
                        <div type="primary_400-ghost" class="notificationButtonWrapper-sc">
                            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/frame.e4ec4254.svg"
                                alt="icon" class="image-sc" />
                ...
                ?>
                    ...
                    <div class="dropdownLoginWrapper-sc">
                        <div class="logedIn-sc">
                            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/avatarIcon.71e3ec8b.svg"
                                alt="Avatar" class="avatarImagen">
                            <div class="myPageNavigate-sc"
                                data-href="https://kurabun-ec-develop.vercel.app/my-page?tab=1">マイページ</div>
                            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/triangleIcon.ace1990e.svg"
                                alt="Dropdown icon" class="dropdownIcon-sc">
                        </div>
                        <div class="loginDropdown-sc">
                            <div class="buttonWrapper-sc">
                                <button data-testid="btn-submit" type="submit" class="button-sc"
                                    data-href="https://kurabun-ec-develop.vercel.app/ready-designed">
                                    <div type="secondary-blank" class="notificationButtonWrapper-sc">
                                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/designSave.760adcf3.svg"
                                            alt="icon" class="image-sc" />
                            ...
                            <div class="buttonWrapper-sc">
                                <button data-testid="btn-submit" type="submit" class="button-sc"
                                    data-href="https://kurabun-ec-develop.vercel.app/ready-designed?tab=1">
                                    <div type="secondary-blank" class="notificationButtonWrapper-sc">
                                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/boughtItemIcon.77f842a8.svg"
                                            alt="icon" class="image-sc" />
                            ...
                            <div class="buttonWrapper-sc">
                                <button data-testid="btn-submit" type="submit" class="button-sc"
                                    data-href="https://kurabun-ec-develop.vercel.app/my-page?tab=3">
                                    <div type="secondary-blank" class="notificationButtonWrapper-sc">
                                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/userUpdateIcon.3e5e0d1c.svg"
                                            alt="icon" class="image-sc" />
                            ...
                            <div class="buttonWrapper-sc">
                                <button data-testid="btn-submit" type="submit" class="button-sc"
                                    data-href="https://kurabun-ec-develop.vercel.app/my-page?tab=4">
                                    <div type="secondary-blank" class="notificationButtonWrapper-sc">
                                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/addressIcon.7dfa2f56.svg"
                                            alt="icon" class="image-sc" />
                            ...
                            <div class="buttonWrapper-sc">
                                <button data-testid="btn-submit" type="submit" class="button-sc"
                                    data-href="https://kurabun-ec-develop.vercel.app/my-page?tab=5">
                                    <div type="secondary-blank" class="notificationButtonWrapper-sc">
                                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/deactivateIcon.c8b19d75.svg"
                                            alt="icon" class="image-sc" />
                            ...
                            <div class="buttonWrapper-sc">
                                <button data-testid="btn-submit" type="submit" class="button-sc">
                                    <div type="secondary-blank" class="notificationButtonWrapper-sc">
                                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/logoutIcon.fd2cde3e.svg"
                                            alt="icon" class="image-sc" />
                ...
                ?>
                    ...
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/menu.257925d3.svg"
                        alt="Menu-icon" id="btn-nav-menu" class="icon-sc" />
                </div>
            </div>
        </div>
    </header>
            ...
            <div class="menuWrapper-sc-main">
                <div class="itemWrapper-sc" data-href="https://karabun.tranbang.work/for-newbie">
                    <div class="menuItem-sc">
                        <div class="menuText-sc">初めての方へ</div>
                    </div>
                </div>
                            ...
                            <div class="menuItem-sc-ddousy">
                                ...
                                ">
                                    ...
                                    <img alt="right arrow icon"
                                        ...
                                        decoding="async" data-nimg="intrinsic" class="rightImage-sc-ddousy"
